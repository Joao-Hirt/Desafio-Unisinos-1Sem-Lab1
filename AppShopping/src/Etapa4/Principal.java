        ...
        while (opcao > 0 && opcao <= 3){
            ...
            switch (opcao){
                case 1:
                    ...
                    int quantidadeMaximaDeProdutos = scanner.nextInt();
                    loja = new Loja(nomeLoja, quantidadeFuncionariosLoja, salarioBaseFuncionariosLoja, enderecoLoja, dataLoja, quantidadeMaximaDeProdutos);
